<template>
  <div class="relative py-3 sm:max-w-xl sm:mx-auto">
    ...
    <div class="relative px-4 py-8 bg-white shadow-lg sm:rounded-2xl sm:p-10 dark:bg-gray-800 dark:text-gray-100">
      <div class="max-w-xl mx-auto">
        ...
        <p class="font-light text-xl mt-6">
          Adoro l'informatica e la musica elettronica.
        </p>
        <div class="mt-7">
          <p class="text-gray-500 dark:text-dark-light">
            Mi trovi anche su
          </p>
          <ul class="mt-2">
            ...
            <!-- <router-link to="/cv">
              <Social name="Curriculum Vitae" class="float-right"><b-icon-card-checklist /></Social>
            </router-link> -->

            <Social name="E-Mail" link="mailto:alex3025game@gmail.com" class="float-right"><b-icon-envelope-fill /></Social>
          </ul>
        </div>
      </div>
    </div>
